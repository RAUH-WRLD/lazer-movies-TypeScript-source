                ...
                <div className={`${pageClass}__main`} ref={this.mainRef}>
                    <div className="main__wrapper">
                        <div className="main__content">
                            <MainStartContentSection data={{data: data.data.startContentSection, movieId: data.movieId}} checkLoading={this.checkLoading} />
                            <MainEndContentSection data={data.data.endContentSection} hrefs={hrefs.endContentSection} />
                        </div>
                    </div>
                </div>
            </main>
